    ...
    var setTable = function(data){
        ...
        _.forEach(data.rows, function(v){
            ...
            var html = '<tr> ' +
                ...
                '<li> '+
                '<a href="#" data-action="edit" data-name="'+ v.unitname +'" data-id="'+ v.id +'") > '+
